 ...
 * is lost. Programming mistakes, such as a null dependency, use
    ...
    extends Exception
{
     ...
     * message should say exactly what to fix, for example "Amount must be a
     * positive number, such as 25.50".
     *
     * @param message
