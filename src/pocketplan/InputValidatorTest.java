    ...
    extends TestCase
{
    ...
    public void testValidateAmountValid()
    {
        try
        {
            assertEquals(
                45.75,
                InputValidator.validatePositiveAmount("45.75", "amount"),
                0.001);
            assertEquals(
                100.0,
                InputValidator.validatePositiveAmount("100", "amount"),
                0.001);
            assertEquals(
                50.0,
                InputValidator.validatePositiveAmount("$50", "amount"),
                0.001);
            assertEquals(
                12.34,
                InputValidator.validatePositiveAmount("12.34", "amount"),
                0.001);
        }
        catch (InvalidInputException e)
        {
            fail(
                "Valid input threw an unexpected InvalidInputException: "
                    + e.getMessage());
        }
    }
    ...
    public void testValidateAmountZero()
    {
        try
        {
            InputValidator.validatePositiveAmount("0", "amount");
            fail(
                "Expected InvalidInputException was not thrown for amount = 0");
        }
        catch (InvalidInputException e)
        {
    ...
    public void testValidateAmountNegative()
    {
        try
        {
            InputValidator.validatePositiveAmount("-50.00", "amount");
            fail(
                "Expected InvalidInputException was not thrown for negative amount");
        }
        catch (InvalidInputException e)
        {
            assertTrue(e.getMessage().contains("greater than 0"));
    ...
    public void testValidateAmountNonNumeric()
    {
        try
        {
            InputValidator.validatePositiveAmount("twenty", "amount");
            fail(
                "Expected InvalidInputException was not thrown for non-numeric text");
        }
        catch (InvalidInputException e)
        {
    ...
    public void testValidateAmountEmptyAndNull()
    {
        ...
        try
        {
            InputValidator.validatePositiveAmount(null, "amount");
    ...
    public void testValidateCategoryValid()
    {
        try
        {
            assertEquals(
                Category.FOOD,
                InputValidator.validateCategory("FOOD"));
            assertEquals(
                Category.FOOD,
                InputValidator.validateCategory("food"));
            assertEquals(
                Category.TRANSPORTATION,
                InputValidator.validateCategory("Transportation"));
            assertEquals(
                Category.OTHER,
                InputValidator.validateCategory("  other  "));
        }
        catch (InvalidInputException e)
        {
    ...
    /**
     * Test unknown category name throws an InvalidInputException listing
     * options.
     */
    public void testValidateCategoryInvalidName()
    {
        try
        {
            ...
            fail(
                "Expected InvalidInputException for unknown category 'shopping'");
        }
        catch (InvalidInputException e)
        {
    ...
    public void testValidateDateValid()
    {
        ...
        {
            fail(
                "Valid date threw an unexpected InvalidInputException: "
                    + e.getMessage());
        }
    }
    ...
    public void testValidateMenuChoiceValid()
    {
        try
        {
            assertEquals(1, InputValidator.validateMenuChoice("1", 1, 8));
            assertEquals(4, InputValidator.validateMenuChoice("4", 1, 8));
            assertEquals(8, InputValidator.validateMenuChoice("8", 1, 8));
        }
        catch (InvalidInputException e)
        {
    ...
    public void testValidateMenuChoiceOutOfRange()
    {
        ...
        try
        {
            InputValidator.validateMenuChoice("0", 1, 8);
        ...
        try
        {
            InputValidator.validateMenuChoice("9", 1, 8);
            fail("Expected InvalidInputException for choice 9 above max 8\");");
        }
        catch (InvalidInputException e)
        {
            assertTrue(e.getMessage().contains("Choice out of range"));
    ...
    public void testValidateMenuChoiceNonInteger()
    {
        ...
        {
            assertTrue(
                e.getMessage().contains("Please enter a valid whole number"));
        }
    }


    public void testValidateDescriptionValid()
    {
        try
        {
            assertEquals(
                "Weekly groceries",
                InputValidator.validateDescription("  Weekly groceries  "));
        }
        catch (InvalidInputException e)
        {
            fail(
                "Valid description threw an unexpected "
                    + "InvalidInputException");
        }
    }


    public void testValidateDescriptionInvalid()
    {
        try
        {
            InputValidator.validateDescription("   ");
            fail("Expected InvalidInputException for blank description");
        }
        catch (InvalidInputException e)
        {
    ...
    public void testValidateHabitualTagValid()
    {
        try
        {
            assertTrue(InputValidator.validateHabitualTag("yes"));

            assertTrue(InputValidator.validateHabitualTag("y"));

            assertFalse(InputValidator.validateHabitualTag("no"));

            assertFalse(InputValidator.validateHabitualTag("n"));
        }
        catch (InvalidInputException e)
        {
            fail(
                "Valid habitual tag threw an unexpected "
                    + "InvalidInputException");
        }
    }


    public void testValidateHabitualTagInvalid()
    {
        try
        {
            InputValidator.validateHabitualTag("maybe");
            fail(
                "Expected InvalidInputException for invalid "
                    + "habitual response");
        }
        catch (InvalidInputException e)
        {
            assertTrue(e.getMessage().contains("Please enter 'yes' or 'no'"));
        }
    }


    public void testValidateExpenseIdValid()
    {
        try
        {
            assertEquals(5, InputValidator.validateExpenseId("5"));
        }
        catch (InvalidInputException e)
        {
            fail(
                "Valid expense ID threw an unexpected "
                    + "InvalidInputException");
        }
    }


    public void testValidateExpenseIdInvalid()
    {
        try
        {
            InputValidator.validateExpenseId("-1");
            fail("Expected InvalidInputException for negative " + "expense ID");
        }
        catch (InvalidInputException e)
        {
            assertTrue(
                e.getMessage()
                    .contains("Expense ID must be a positive integer"));
        }
    }
